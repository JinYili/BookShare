    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> EditRole(RoleEditViewModel roleEditViewModel)
        {
            ...
            if (role != null)
            {
                ...
                ModelState.AddModelError(string.Empty, "Error occurs in editing role");
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            if (role != null)
            {
                ...
                ModelState.AddModelError(string.Empty, "Error occurs in delete role");
            }
            ModelState.AddModelError(string.Empty, "Role can't be found");
        ...
        public async Task<IActionResult> AddUserToRole(UserRoleViewModel userRoleViewModel)
        {
            ...
            ModelState.AddModelError(string.Empty, "User or role can't be found");
            return View(userRoleViewModel);
        }
        ...
        public async Task<IActionResult> DeleteUserFromRole(UserRoleViewModel userRoleViewModel)
        {
            ...
            if (user != null && role != null)
            {
                ...
                ModelState.AddModelError(string.Empty, "User not belong to this role");
                return View(userRoleViewModel);
            }
        ...
        public async Task<IActionResult> CheckRoleExist([Bind("RoleName")] string roleName)
        {
            ...
            {
                // return Json(false);
                return Json("Role already existed");
            }
